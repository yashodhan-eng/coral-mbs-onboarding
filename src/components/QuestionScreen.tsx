...
export const QuestionScreen = ({ 
  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 py-2 animate-fade-in">
      {onBack && (
        <button
          onClick={onBack}
        ...
        <div className="space-y-3 md:space-y-5">
          {options.map((option, index) => (
            <Button
              ...
              className="w-full h-auto min-h-[56px] md:min-h-[60px] py-4 md:py-5 px-5 md:px-6 text-[15px] md:text-lg font-medium rounded-2xl

        ...
        <div className="animate-fade-in">
          <div className="w-full max-w-[900px] mx-auto px-6 md:px-10 lg:px-20">
            ...
            <div className="mb-8 max-w-[600px] mx-auto">
              <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.05)] p-4 min-h-[120px] flex flex-col justify-center transition-all duration-500">
                <div className="flex gap-1 mb-2 justify-center">
                  {renderStars(testimonials[currentTestimonial].rating)}
                </div>
                <p className="font-poppins text-[14px] text-foreground text-center leading-relaxed mb-3">
            ...
            <div className="mb-8 max-w-[500px] mx-auto">
              <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.05)] p-4 flex items-center justify-center gap-3 min-h-[70px] transition-all duration-500">
                <FeatureIcon className="w-6 h-6 text-primary flex-shrink-0" strokeWidth={2} />
                <p className="font-poppins font-medium text-[14px] md:text-[15px] text-foreground text-center">
